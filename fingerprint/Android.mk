...
LOCAL_MODULE := android.hardware.biometrics.fingerprint@2.3-service-samsung.a53x
LOCAL_CFLAGS += -DLOG_TAG="\"$(LOCAL_MODULE)\""
LOCAL_INIT_RC := android.hardware.biometrics.fingerprint@2.3-service-samsung.a53x.rc
LOCAL_VINTF_FRAGMENTS := android.hardware.biometrics.fingerprint@2.3-service-samsung.a53x.xml
